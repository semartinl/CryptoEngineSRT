...
public class MainGUI extends JFrame{
    ...
    private JPanel crearPanelCifrado() {
        ...
        btnCifrar.addActionListener((ActionEvent e) -> {
            ...
            //Comprobación por si la contraseña es demasiado debil
            if (strength == 0) {
            ...
            try {
                //Calcular el hash de la contraseña para guardarlo en la cabecera
        ...
        btnDescifrar.addActionListener((ActionEvent e) -> {
            ...
            try {
                //Comprobación de la contraseña coincide con la guardada al cifrar el archivo.
                byte[] hash = calcularHash(pass);
