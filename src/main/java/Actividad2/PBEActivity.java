...
public class PBEActivity {
    ...
    public static void processingDecipher(String fichero, String password, int numIteraciones) throws Exception {
        ...
        //Comprobamos exista una cabecera en el archivo.
            if (h.load(fis)) {
                //Comprobamos que la cabecera del archivo se ha realizado un cifrado del archivo.
                if(h.getOperation() == Options.OP_SYMMETRIC_CIPHER){
                ...
                else throw new Exception("No se puede descifrar un fichero que no ha sido cifrado.");
        }
