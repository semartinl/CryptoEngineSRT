...
public class GUI extends JFrame {
    ...
    //Función que nos devuelve el algoritmo elegido en el campo de "Algoritmo".
    public String getAlgorithm() {
        return algorithmCombo.getSelectedItem().toString();
    }

    //Función que nos devuelve el número de iteraciones guardado en el camop de "Iteraciones".
    public int getIterations() {
        return Integer.parseInt(iterations.getValue().toString());
    }

    //Se trata del constructor por defecto, que inicializa los parámetros y campos necesarios para construir la Interfaz Gráfica de Usuario.
    public GUI() {
        ...
        // Campos de contraseña. Se establece e inicializa los campos de contraseña, que se utilizará en el algoritmo de cifrado.
    ...
    //Se trata de una función auxiliar, utilizada para poder añadir a un panel, un componente, estableciendo la posicion y el estilo del componente.
    ...
    //Esta función, tiene como objetivo establecer los eventos y comportamientos que se desea por cada componente y funcionalidad de nuestra aplicación.
    private void configureListeners() {
        // Se configura el listener para el botón de selección de archivo origen. Hace que, cada vez que se hace click en el botón de "sourceButton", se ejecuta la función de "SelectSourceFile"
        sourceButton.addActionListener(e -> selectSourceFile());

        // Listener para el campo de archivo fuente. Se configura el comportamiento a la hora de elegir el documento fuente en la aplicación.
        ...
        //Se establece el evento y el comportamiento que se desea cuando se hace click sobre el boton de "Encriptar"
        encryptButton.addActionListener(e -> {
            //Se establece la variable a true, haciendo ver que se quiere cifrar.
            isEncrypting = true;
            updateDestinationFile();
            //Esta condicional, nos ayuda a comprobar si se trata de un archivo correcto.Si es así, se procede a ejecutar la función deseada. Si no, se mostrará un mensaje de error.
            if (validateInputs()) {
                try {
    ...
    //Esta función, nos permite abrir la ventana para elegir el fichero fuente deseado de nuestro dispositivo. El fichero elegido se guarda en la variable "sourceFile" de nuestra clase.
    ...
    //Una vez elegido el fichero fuente, dependiendo de su extensión, se actualizará para mostrar el fichero que se creará o modificará, si este ya existe.
    ...
    //Esta función nos permite asegurarnos de que todos los campos de la ventana de elección sean válidos. 
